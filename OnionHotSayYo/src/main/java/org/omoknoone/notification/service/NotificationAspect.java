package org.omoknoone.notification.service;
...
import org.omoknoone.comment.service.CommentService;
import org.omoknoone.follow.dto.FollowDTO;
...
import org.omoknoone.post.service.PostService;
import org.omoknoone.post.vo.ResponsePostDetail;
...
public class NotificationAspect {
	...
	// 댓글 알림
	@Pointcut("execution(* org.omoknoone.comment.service.CommentService.createComment(..)) && args(commentDTO)")
	private void commentServiceCreateComment(CommentDTO commentDTO) {}

	// 대댓글 알림
	@Pointcut("execution(* org.omoknoone.reply.service.ReplyService.createReply(..)) && args(replyDTO)")
	private void replyServiceCreateReply(ReplyDTO replyDTO) {}

	// 팔로우 알림
	@Pointcut("execution(* org.omoknoone.follow.service.FollowService.followMember(..)) && args(followDTO)")
	private void followServiceFollowMember(FollowDTO followDTO) {}

	// 쪽지 알림
	@Pointcut("execution(* org.omoknoone.letter.service.LetterService.sendLetter(..)) && args(letterDTO)")
