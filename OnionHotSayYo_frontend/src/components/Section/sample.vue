<template>
    ...
    <main class="container">
        ...
        <div class="row g-5">
            <div class="col-md-8" style="float:left; width: 100%; margin: 0 20px">
                <div class="category_1"
                    style="float:left; width: 33.3%; margin: 0 -25px; padding: 0 15px; margin-bottom: 25px;">
                    <div class="best_mq1">
                        <div class="gpe_wgPopularT2">
                            <h3 class="wgP_title naF_sq"><i class="xi-heart"></i>정보글 Best</h3>
                            <div>
                ...
                <div class="category_2"
                    ...
                    <div class="best_mq1">
                        <div class="gpe_wgPopularT2">
                            <h3 class="wgP_title naF_sq"><i class="xi-heart"></i>중고거래글 Best</h3>
                            <div>
                                <ul class="wgP_contents relative">
                                    <li class="popu_li">
                                        <span class="de_num num01">1</span>
                ...
                <div class="category_3"
                    style="float:left; width: 33.3%; margin: 0 -25px; padding: 0 15px; margin-bottom: 20px;">
                    <div class="best_mq1">
                        <div class="gpe_wgPopularT2">
                            <h3 class="wgP_title naF_sq"><i class="xi-heart"></i>직장글 Best</h3>
                            <div>
                                <ul class="wgP_contents relative">
                                    <li class="popu_li">
                                        <span class="de_num num01">1</span>
