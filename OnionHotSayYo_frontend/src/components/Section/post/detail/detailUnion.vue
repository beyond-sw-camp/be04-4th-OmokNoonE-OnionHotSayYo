...
<br>
<br>
      <textarea v-model="message" placeholder="댓글을 입력하세요" style="width: 100%;"></textarea>
...
.tbAdd th,
.tbAdd td {
    border: 1px solid #dee2e6; /* 테이블 셀 경계선 스타일 지정 */
...
.tbAdd{align-content: center;}
.tbAdd th, .tbAdd td{border-bottom:1px solid #d1d1d1; padding:5px 0;}
.tbAdd td{padding:10px 10px; box-sizing:border-box; text-align:center;}
.tbAdd td.txt_cont{height:300px; vertical-align:top;}
.btnWrap{text-align:center; margin:20 0 0 0; border: 1px solid; padding: 0 20%;}
